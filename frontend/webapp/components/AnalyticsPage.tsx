...
import { analyticsApi, PatientGrowthData, TreatmentData, DemographicsData } from '../lib';
              ...
              <tbody className="divide-y divide-gray-50">
                {filteredTreatments.map((item, index) => (
                  <tr key={index} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-8 py-5">
                      <div className={`flex items-center gap-1 font-bold text-xs ${item.trend > 0 ? 'text-green-600' : item.trend < 0 ? 'text-red-500' : 'text-gray-400'
                        }`}>
